...
export interface PiezasRepositoryInterface {
    ...
    deletePiezaById(id: string): Promise<IPieza | null>;
    createPieza(id: string, producto:string, categoria:string, precio:number, descripcion:string, codigo:string, marca:string, stock:string, modelosVehiculos:string[]): Promise<IPieza>;
